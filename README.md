...
[![Tests](https://img.shields.io/badge/tests-31%2F31%20%E2%9C%85-green)](tests/)
...
| 🤖 全自动托管 | GitHub Actions 每天定时打卡 + 微信通知 |
| 🔒 安全认证 | 基于 OpenID 的 OAuth 登录，密码混淆本地存储 |
| 🧪 算法可验证 | 31 个自动化测试，JS/Python 签名交叉验证 |
...
A: 手机本身无法设代理时，可用：
- **Reaple**（原 HTTPCanary）：本地 VPN 抓包，无需代理
